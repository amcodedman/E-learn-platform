    ...
    >
      <div className="registerme">
        <div
          ...
          style={{
            backgroundImage: `url('https://cdn.pixabay.com/photo/2013/07/13/12/43/kids-160168_1280.png')`,
          }}
        >
          <span>
          Welcome to Mathic learn platform . Login now to continue playing more
